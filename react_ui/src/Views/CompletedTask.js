...
class CompletedTask extends Component{
	...
	render() {
        ...
        if (this.state.successful){
            msg = <p>Success! You have been logged as completed to do the task. Transaction hash: {this.state.transactionHash}. Kindly await for the right person to verify it and get paid.</p>
        }
		...
		return (        
          <div id="logCompleted" className="CompletedTask">            
            ...
            <p>If you have completed a task that you have confirmed as doing, then please log the task as completed by entering its id, so that the right person may verify it and process the payment.</p>
